      ...
      <div className="px-5 sm:px-8">
        <div className="grid gap-8 sm:grid-cols-12 sm:items-start sm:gap-10">
          <div className="sm:col-span-5">
            ...
            <ParallaxText range={-32} className="mt-8 sm:mt-12">
              <p className="text-paper/55 font-sans text-xs tracking-[0.15em] uppercase sm:text-sm">
                Available To Travel
              </p>
              <p className="font-display text-paper mt-3 text-2xl leading-snug sm:text-3xl">
                Nashville based.
                <br />
                Available beyond.
              </p>
              <p className="text-paper/60 mt-4 max-w-xs font-sans">
                Available for select campaigns, shoots, events and travel
                opportunities.
              </p>
            </ParallaxText>
          </div>

          {/* Supporting images: asymmetric, airy, edge reveals reinforce movement */}
          <div className="flex flex-col gap-10 sm:col-span-6 sm:col-start-7 sm:gap-16 sm:pt-10">
            <div className="grid grid-cols-2 gap-5 sm:gap-8">
              ...
              <RevealImage
                delay={0.16}
                direction="right"
                className="mt-8 aspect-[3/4] sm:mt-14"
              >
                <Image
